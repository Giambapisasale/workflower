# Workflower
Sistema LLM-driven per controllo costi cantieri. Leggere: analisi-progettazione.md, piano-implementazione.md (v1, M0–M6), piano-implementazione-fase2.md (M7–M12).
## Regole
